...
class LoginController extends Controller
{
    ...
    */
    ...
    public function login(Request $request)
    {
        ...
        /**
         * VERIFICA SE A CONTA DO USUÁRIO ESTÁ ATIVO PARA FAZER O LOGIN
         */
        $_isUserActive = User::where('email', $request->email)->where('active', 1)->first();;
        if (!$_isUserActive) {
        ...
        /**
         * FOI COPIADO DA TRAIT AuthenticatesUsers METHOD login
         */
