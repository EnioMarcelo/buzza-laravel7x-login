...
<div class="row">
    ...
    <div class="col">
        <a class="btn btn-block btn-outline-primary col-md-7 col-lg-7 col-xl-6 m-auto"
            href="{{ route('admin.usuario.create') }}"><i class="fa fa-plus"></i> Novo Usuário</a>
    </div>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <input type="checkbox" class="btn-active" name="active"
                            ...
                            data-action="{{ route('admin.usuario.btnactive',['usuario'=>$usuario->id]) }}"
